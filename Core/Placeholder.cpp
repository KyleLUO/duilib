...
void PlaceHolder::SetMinWidth(int cx, bool bNeedDpiScale)
{
	if (bNeedDpiScale && cx > 0)
		DpiManager::GetInstance()->ScaleInt(cx);
...
void PlaceHolder::SetMaxWidth(int cx, bool bNeedDpiScale)
{
	if (bNeedDpiScale && cx > 0)
		DpiManager::GetInstance()->ScaleInt(cx);
...
void PlaceHolder::SetMinHeight(int cy, bool bNeedDpiScale)
{
	if (bNeedDpiScale && cy > 0)
		DpiManager::GetInstance()->ScaleInt(cy);
...
void PlaceHolder::SetMaxHeight(int cy, bool bNeedDpiScale)
{
	if (bNeedDpiScale && cy > 0)
		DpiManager::GetInstance()->ScaleInt(cy);
