...
public:
	...
	void SetMinWidth(int cx, bool bNeedDpiScale);
	...
	void SetMaxWidth(int cx, bool bNeedDpiScale);
	...
	void SetMinHeight(int cy, bool bNeedDpiScale);
	...
	void SetMaxHeight(int cy, bool bNeedDpiScale);
