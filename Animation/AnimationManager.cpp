...
AnimationPlayer* AnimationManager::SetFadeHot(bool bFadeHot)
{
	...
	if (bFadeHot) {
		...
		if (speed_ratio_ > 0)
		{
			animationArgs->SetSpeedUpRatio(speed_ratio_);
			animationArgs->SetSpeedDownRatio(speed_ratio_);
		}
		else
		{
...
void AnimationManager::SetSpeedRatio(float speed_ratio)
{
