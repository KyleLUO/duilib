...
DEFINE_GUID(GUID_RichTextFixAlphaShader, 0x7717FB29, 0x06A0, 0x560F, 0xAA, 0x9C, 0x8B, 0x8F, 0xF0, 0x33, 0x5E, 0xA6);
DEFINE_GUID(CLSID_RichTextFixAlphaEffect, 0xC7C36C92, 0x3498, 0x5A94, 0x9E, 0x95, 0x9F, 0x24, 0x6F, 0x92, 0x45, 0xBF);

typedef struct
{
	D2D1_RECT_F TextColor;  // abgr
} FIX_META;

enum FIX_ALPHA_PROP
{
	FIX_ALPHA_PROP_ALPHA = 0,
};

class RichTextFixAlphaEffect : public ID2D1EffectImpl, public ID2D1DrawTransform
{
public:
	HRESULT SetTextColor(D2D1_RECT_F textColor);
	D2D1_RECT_F GetTextColor() const;
public:
	...
	static HRESULT CALLBACK CreateRichTextFixAlphaEffect(_Outptr_ IUnknown** ppEffectImpl);
