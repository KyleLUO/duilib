...
class UILIB_API ToolTipCtrl : public ui::WindowImplBase
{
public:
	ToolTipCtrl();
	~ToolTipCtrl();
...
private:
	...
	ui::Control*	ctl_tooltip_left_   = nullptr;
	ui::Control*	ctl_tooltip_top_    = nullptr;
	ui::Control*	ctl_tooltip_right_  = nullptr;
	ui::Control*	ctl_tooltip_bottom_ = nullptr;
