...
{
public:
	CComboWnd(const wchar_t *bk_path);
...
CComboWnd::CComboWnd(const wchar_t *bk_path):Window(bk_path)
{
	;
}
...
void CComboWnd::Init(Combo* pOwner)
{
    ...
    MyMapWindowRect(pOwner->GetWindow()->GetHWND(), HWND_DESKTOP, &rc);
	...
	m_bPopupTop(false)
{
	...
	m_pLayout->SetBkColor(L"color_ffffffff");
	m_pLayout->SetBorderColor(L"color_ff8da1b8");
...
void Combo::Activate()
{
    ...
    m_pWindow = new CComboWnd(L"file='../../global/res/bk/bk_shadow3.png' corner='15,15,15,15'");
    ASSERT(m_pWindow);
    m_pWindow->Init(this);
